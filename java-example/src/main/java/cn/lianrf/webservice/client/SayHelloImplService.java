 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://server.webservice.lianrf.cn/", wsdlLocation = "http://localhost:8080/say?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://server.webservice.lianrf.cn/", "SayHelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/say?wsdl");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://server.webservice.lianrf.cn/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.lianrf.cn/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }

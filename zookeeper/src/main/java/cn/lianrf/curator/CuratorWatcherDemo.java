...
/**
 * Created by lianrongfa on 2018/6/18.
 */
public class CuratorWatcherDemo {

    public static void main(String[] args) throws Exception {
        CuratorFramework curatorFramework=CuratorFrameworkFactory.
                builder().connectString("120.77.243.179:2181").
        ...
        //当前节点的创建和删除事件监听
//        addListenerWithNodeCache(curatorFramework,"/lianrf");
        //子节点的增加、修改、删除的事件监听
//        addListenerWithPathChildCache(curatorFramework,"/lianrf");

        //综合节点监听事件
        addListenerWithTreeCache(curatorFramework,"/lianrf");
        System.in.read();
    }
